...
class ApplicationController extends Controller
{
            ...
            if (! $isEdit) {
                ...
                $filesToUpload = [
                    'business_registration' => [
                        'folder_name' => 'Business Registration',
                        'requirement_id' => 7,
                    ],
                    'soc_certificate' => [
    ...
    public function government_apply(Request $request, GoogleDriveService $driveService)
    {
        try {
    ...
    public function updateApplicantFiles(Request $request, GoogleDriveService $driveService)
    {
        try {
            ...
            $folderMap = [
                ...
                'othersDocs' => ['folder' => 'Other supporting documents', 'prefix' => 'other_supporting_documents_'],
            ...
            $mainFolder = match ($application_type) {
    ...
    try {
        ...
        //  * Resolve main folder
        //  */
        // $mainFolder = match ($application->application_type) {
        ...
        //     $basePath.'/Permit to Sell',

        //     $basePath.'/Mayors Permit',

        //     $basePath.'/Notarized Affidavit',

        //     $basePath.'/Official Receipts',

        //     $basePath.'/Request Letter',

        //     $basePath.'/Secretary Certificate',

        //     $basePath.'/Other supporting documents',

        //     $basePath.'/Resubmissions',
        // ];

        // /**
        //  * Locate actual file path
        //  */
        // $filePath = null;
        ...
        //     $foundPath = $driveService->getDriveFilePath(
        //         $attachment->file_id,
        //         $folder
        //     );
        ...
        //     Log::warning(
        //         'File not found in Google Drive for ID: '
        //             .$attachment->file_id
        //     );
        ...
        // Log::info(
        //     'Resolved Google Drive file path: '
        //         .$filePath
        // );
    ...
    public function summary(Request $request)
    {
        ...
        $query = DB::table('tbl_application_checklist')
            ...
            ->select(
                ...
                DB::raw('SUM(CASE WHEN application_status BETWEEN 3 AND 24 THEN 1 ELSE 0 END) as draft'),
            ...
            ->when($office_id != 13, function ($query) use ($statusFilter) {
                return $query->whereIn('application_status', $statusFilter);
            })
