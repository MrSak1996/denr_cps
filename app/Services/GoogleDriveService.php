...
class GoogleDriveService
{
    ...
    public function storeResubmissionAttachment($file, $folderStructure, $folderType, $customFileName)
    {
        try {
            /**
    ...
    public function deleteAttachment($fileId, $folderPath = '')
{
    try {
        ...
        // ✅ Locate actual Google Drive path
        $filePath = $this->getDriveFilePath(
            $fileId,
            $folderPath
        );
        ...
        if (!$filePath) {
            ...
            Log::warning(
                "Google Drive file not found. File ID: {$fileId}, Folder: {$folderPath}"
            );
        ...
        Log::info(
            "Deleted Google Drive file: {$filePath}"
        );
     ...
     */
    public function getDriveFilePath($fileId, $folderPath)
    {
        try {
