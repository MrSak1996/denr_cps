...
class RequestContext
{
    ...
    public function __construct(string $baseUrl = '', string $method = 'GET', string $host = '10.201.6.213', string $scheme = 'http', int $httpPort = 80, int $httpsPort = 443, string $path = '/', string $queryString = '', ?array $parameters = null)
    {
    ...
    public static function fromUri(string $uri, string $host = '10.201.6.213', string $scheme = 'http', int $httpPort = 80, int $httpsPort = 443): self
    {
