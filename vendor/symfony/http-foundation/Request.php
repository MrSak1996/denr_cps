...
class Request
{
    ...
    public static function create(string $uri, string $method = 'GET', array $parameters = [], array $cookies = [], array $files = [], array $server = [], $content = null): static
    {
        $server = array_replace([
            'SERVER_NAME' => '10.201.6.213',
            'SERVER_PORT' => 80,
            'HTTP_HOST' => '10.201.6.213',
     ...
     *
     * Suppose this request is instantiated from /mysite on 10.201.6.213:
     *
     *  * http://10.201.6.213/mysite              returns '/'
     *  * http://10.201.6.213/mysite/about        returns '/about'
     *  * http://10.201.6.213/mysite/enco%20ded   returns '/enco%20ded'
     *  * http://10.201.6.213/mysite/about?var=1  returns '/about'
     *
     ...
     *
     *  * http://10.201.6.213/index.php         returns an empty string
     *  * http://10.201.6.213/index.php/page    returns an empty string
     *  * http://10.201.6.213/web/index.php     returns '/web'
     *  * http://10.201.6.213/we%20b/index.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
