...
const PendingTable = defineAsyncComponent(() => import('./applications/table/penro_tsd_chief_tbl.vue'));
...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'PENRO TSD Chief Dashboard',
        href: '/penro-tsd-chief-dashboard',
    },
];
...
const fetchDashboardData = async () => {
    try {
        ...
        const response = await axios.get('https://cps.denrcalabarzon.com/api/summary', {
            params: { user_id: userId,office_id:officeId,status:STATUS_ENDORSED_PENRO_CHIEF_TSD}
...
<template>
    ...
    <Head title="PENRO TSD Chief Dashboard" />
        ...
        <div class="flex flex-col gap-6 rounded-xl p-4">
            ...
            <div class="box">
                <div class="flex items-center gap-2 text-sm">
                    <List class="h-5 w-5" />
            <h1 class="text-xl font-semibold"> PENRO TSD Chief Dashboard</h1>
                </div>
