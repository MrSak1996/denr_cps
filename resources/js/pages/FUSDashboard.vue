...
const fus_table = defineAsyncComponent(() => import('./applications/table/fus_tbl.vue'));
...
const fetchDashboardData = async () => {
    try {
        ...
        const response = await axios.get('https://cps.denrcalabarzon.com/api/summary', {
            params: { user_id: userId,office_id:officeId,status:STATUS_ENDORSED_FUS_CHIEF }
...
<template>
    ...
    <Head title="Regional Office Dashboard" />
        ...
        <div class="flex flex-col gap-6 rounded-xl p-4">
            ...
            <div class="box">
                <div class="flex items-center gap-2 text-sm">
                    <List class="h-5 w-5" />
                    <h1 class="text-xl font-semibold"> {{ officeTitle }} Dashboard (FUS Chief)</h1>
                </div>
