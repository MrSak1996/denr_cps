...
const PendingTable = defineAsyncComponent(() => import('./applications/table/rts_tbl.vue'));
const { officeTitle } = useOfficeTitle();
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Regional Technical Staff Dashboard',
        href: '/rts-dashboard',
    },
];
...
const fetchDashboardData = async () => {
    try {
        ...
        const response = await axios.get('https://cps.denrcalabarzon.com/api/summary', {
            params: { user_id: userId,office_id:officeId,status:STATUS_ENDORSED_REGIONAL_TECHNICAL_STAFF}
...
<template>
    ...
    <Head title="Regional Technical Staff Dashboard" />
