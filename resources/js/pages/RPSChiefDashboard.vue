...
const PendingTable = defineAsyncComponent(() => import('./applications/table/rpschief_tbl.vue') );
...
const fetchDashboardData = async () => {
    try {
        ...
        const response = await axios.get('https://cps.denrcalabarzon.com/api/summary', {
            params: { user_id: userId,office_id:officeId,status:STATUS_ENDORSED_CENRO_RPS_CHIEF}
