    ...
    return (props.files || [])
        ...
        .filter((file: any) =>
            ...
            file.application_id === props.form.id && (
                file.name.startsWith('request_letter') ||
    ...
    <div class="space-y-6">
        ...
        <Fieldset legend="Chainsaw Application">
            ...
            <div class="mt-4 grid gap-4 md:grid-cols-3">
                ...
                <FloatLabel>
                    <Select v-model="props.form.type_of_transaction" :options="['G2G']" :disabled="isEdit"
                        class="w-full" />
                ...
                <div class="mt-4 grid gap-6 md:grid-cols-3">
                    ...
                    <div class="md:col-span-2 mt-2">
                        <FloatLabel>
                            ...
                            <label for="surname">Government Agency</label>
                        </FloatLabel>
                ...
                <div v-else>
                    <div class="grid gap-6 md:grid-cols-1">
                        <div class="flex flex-col md:col-span-2">
                            <label for="requestLetter" class="mb-2 text-sm font-medium text-gray-700">Upload Duly accomplished Application Form/Letter of Intent</label>
                     ...
                     <div class="grid gap-6 md:grid-cols-1 mt-2">
                        <div class="flex flex-col md:col-span-2">
                            <label for="requestLetter" class="mb-2 text-sm font-medium text-gray-700"> Upload Authorization Documents for representative/requesting person</label>
                            <input type="file" id="requestLetter" accept="application/pdf"
        ...
        <Fieldset legend="Complete Address">
            <div class="grid gap-4 md:grid-cols-4">
                ...
                <div class="md:col-span-4">
                    ...
                    <Textarea v-model="props.form.company_address" placeholder="Please input the complete address" rows="4" class="w-full" />
                </div>
            </div>
        </Fieldset>
