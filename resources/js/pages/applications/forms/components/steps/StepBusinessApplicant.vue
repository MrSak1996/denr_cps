    ...
    return (props.files || [])
        ...
        typeof file.name === 'string' &&
            file.application_id === props.form.id && (
                ...
                file.name.startsWith('business_registration') ||
                file.name.startsWith('application_form') ||
                file.name.startsWith('secretary_certificate') ||
                file.name.startsWith('business_license')
            )
        );
});
...
if (props.form.date_applied && typeof props.form.date_applied === 'string') {
        props.form.date_applied = new Date(props.form.date_applied);
    }
    watch(
    ...
    <div class="space-y-6">
        ...
        <Fieldset legend="Chainsaw Application">
            ...
            <div class="relative">
                ...
                <div class="mb-3" v-if="isEdit && files.length > 0">
                    <div class="container">
                ...
                <div v-else>
                     <div class="grid gap-6 md:grid-cols-1">
                        <div class="flex flex-col md:col-span-2">
                            <label for="requestLetter" class="mb-2 text-sm font-medium text-gray-700"> 
                                Upload Duly accomplished Application Form/Letter of Intent</label>
                    ...
                    <div class="grid gap-6 md:grid-cols-1">
                        <div class="flex flex-col md:col-span-2">
                            <label for="requestLetter" class="mb-2 text-sm font-medium text-gray-700">Upload Certificate of Registration of Business Name from DTI or SEC </label>
                            <input type="file" id="requestLetter" accept="application/pdf"
                                @change="e => handleFileUpload(e, 'business_registration')"
                                class="w-full cursor-pointer rounded-lg border border-dashed border-gray-400 bg-white p-3 text-sm text-gray-700 file:mr-4 file:rounded file:border-0 file:bg-blue-100 file:px-4 file:py-2 file:text-blue-700 hover:bg-gray-50" />
                        </div>
                    </div>
                    ...
                    <div class="grid gap-6 md:grid-cols-1">
                        <div class="flex flex-col md:col-span-2">
                            <label for="requestLetter" class="mb-2 text-sm font-medium text-gray-700"> 
                                Upload Business License/Mayor's Permit</label>
                            <input type="file" id="requestLetter" accept="application/pdf"
        ...
        <Fieldset legend="Company Address">
            <div class="grid gap-4 md:grid-cols-4">
                ...
                <div class="md:col-span-4">
                    ...
                    <Textarea v-model="props.form.company_address" rows="4" class="w-full" placeholder="Please input the complete address" />
                </div>
            </div>
        </Fieldset>
