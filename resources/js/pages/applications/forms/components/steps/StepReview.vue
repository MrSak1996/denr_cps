    ...
    <div class="space-y-6">
      ...
      <div :class="[
        ...
        <Button v-if="roleId === 1 || (props.form.status_title !== 'Draft' && currentStep === 4)"
          ...
          class="h-10 w-full px-4 py-2 flex items-center justify-center gap-2 rounded-md bg-red-900 text-white hover:bg-red-50" @click="returnApplication">
          <Undo2 class="h-4 w-4" />
          Return Application
        </Button>
        ...
        <AssessmentModal :disabled="[1].includes(roleId) &&
