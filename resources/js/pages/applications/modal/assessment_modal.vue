...
const requireConfirmation = () => {
    const isRegionalDirector = [13, 24, 28].includes(props.status_id);
    ...
    confirm.require({
        ...
        accept: () => {
            ...
            toast.add({
                severity: 'info',
                summary: isRegionalDirector ? 'Approving' : 'Submitting',
                detail: isRegionalDirector
        ...
        <Button :disabled="props.disabled || isLoading || [28].includes(Number(props.status_id))" @click="requireConfirmation()"
            ...
            {{
                [5, 6, 7, 8, 9].includes(Number(props.status_id))
                    ...
                    : [13, 24, 28].includes(Number(props.status_id))
                        ? 'Approve Application'
                        : 'Submit Application'
            }}
        </Button>
