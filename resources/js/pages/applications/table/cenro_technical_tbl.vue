...
const loadBrands = async (id) => {
    const res = await axios.get(`https://cps.denrcalabarzon.com/api/chainsaw/${id}/brands`);
...
const canView = (row: any) => {
    return [
        STATUS_DRAFT,
        STATUS_RETURNED_TO_CENRO_TECHNICAL
            ...
            <template #header>
                <div class="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <!-- Status Filter -->
                        <Select v-model="filters['application_status'].value" :options="statusOptions" filter
                            optionLabel="label" optionValue="value" placeholder="Filter by Status" class="w-52"
                            showClear />
