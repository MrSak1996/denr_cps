...
const canView = (row: any) => {
    return [
        STATUS_DRAFT,
        STATUS_RETURNED_TO_PENRO_TECHNICAL,
        STATUS_RECEIVED_PENRO_TECHNICAL,
            ...
            <div v-if="activeTab === 're'" class="space-y-2 text-sm text-gray-700">
                <div class="h-auto w-full">
                    <DataTable ref="dt" size="small" v-model:selection="selectedProducts" :value="endorsed_applications"
                        ...
                        <Column header="Action" :exportable="false" style="min-width: 4rem">
                            <template #body="slotProps">
                                <div class="mt-2 flex gap-2" v-if="slotProps.data.role_id == 4">
                                ...
                                <div class="mt-2 flex gap-2" v-else>
                                    ...
                                    <Button v-if="slotProps.data.application_status == STATUS_APPROVED_BY_RED"
                                        ...
                                        style="background-color: #0D47A1;border-color: 1px solid #0D47A1;">
                                        <PrinterCheck :size="15" />
