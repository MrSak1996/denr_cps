            ...
            <div v-for="app in endorsed_applications" :key="app.id" class="border rounded-lg p-3 shadow-sm bg-white">
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        ...
                        <Tag value="Endorsed to ARDTS" severity="success" class="text-xs"
                            v-if="app.status_title == 'Endorsed to ARDTS'" />
                        <Tag value="Received by ARDTS" severity="warn" class="text-xs"
                            v-if="app.status_title == 'Received by ARDTS'" />
                    </div>
