...
import { BadgeCheck, SquarePen, View, PrinterCheck, History, SaveAll, Send, SendIcon, ShieldCheck, Undo2 } from 'lucide-vue-next';
                            ...
                            <Column header="Action" :exportable="false" style="min-width: 2rem">
                                <template #body="slotProps">
                                    <div class="mt-2 flex gap-2">
                                        ...
                                        <Link v-tooltip.top="'View Application'" v-if="canView(slotProps.data)" :href="route('applications.edit', {
