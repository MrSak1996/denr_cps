                ...
                >
                    ...
                    <div class="text-xs">
                        ...
                        <div v-if="row.attachments?.length > 0" class="flex gap-2 flex-wrap">
                            ...
                            <button
                                v-if="row.assessment === 'failed' && !isDraft && canUpload"
                    ...
                    <div class="text-xs">
                        ...
                        <ul>
                            <li
                                v-for="(file, fIndex) in row.resubmissions"
                                :key="fIndex"
                                class="text-gray-600"
                            >
                                • {{ file.file_name }}
