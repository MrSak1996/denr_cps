...
const PendingTable = defineAsyncComponent(() => import('./applications/table/penro_rps_chief_tbl.vue'));
...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'PENRO RPS Chief Dashboard',
        href: '/penro-rps-chief-dashboard',
    },
];
...
const fetchDashboardData = async () => {
    try {
        ...
        const response = await axios.get('https://cps.denrcalabarzon.com/api/summary', {
            params: { user_id: userId,office_id:officeId,status:STATUS_ENDORSED_PENRO_CHIEF_RPS }
        });
...
<template>
    ...
    <Head title="PENRO RPS Chief Dashboard" />
