...
const PendingTable = defineAsyncComponent(() => import('./applications/table/penro_technical_tbl.vue'));

const { officeTitle } = useOfficeTitle();
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'PENRO Technical Dashboard',
        href: '/penro-technical-dashboard',
    },
];
...
<template>
    ...
    <Head title="PENRO Technical Dashboard" />
        ...
        <div class="flex flex-col gap-6 rounded-xl p-4">
            ...
            <div class="box">
                <div class="flex items-center gap-2 text-sm">
                    <List class="h-5 w-5" />
                    <h1 class="text-xl font-semibold">RPS Chief Dashboard ({{ officeTitle }})</h1>
                </div>
