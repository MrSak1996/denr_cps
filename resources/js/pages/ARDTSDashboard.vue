...
const ardts_tbl = defineAsyncComponent(() => import('./applications/table/ardts_tbl.vue'));
...
const fetchDashboardData = async () => {
    try {
        ...
        const response = await axios.get('https://cps.denrcalabarzon.com/api/summary', {
            params: { user_id: userId,office_id:officeId,status:STATUS_ENDORSED_ARDTS}
