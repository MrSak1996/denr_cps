import{a3 as h,ai as g,aj as k,ak as w,al as p,am as f,an as d,ao as S,ap as A,aq as j,ar as O,as as E}from"./app-DFVxlq3q.js";import{s as P}from"./index-BNt3LqSv.js";function $(...e){if(e){let t=[];for(let n=0;n<e.length;n++){const i=e[n];if(!i)continue;const r=typeof i;if(r==="string"||r==="number")t.push(i);else if(r==="object"){const a=Array.isArray(i)?[$(...i)]:Object.entries(i).map(([o,u])=>u?o:void 0);t=a.length?t.concat(a.filter(o=>!!o)):t}}return t.join(" ").trim()}}var _=`
.p-icon {
