...
Route::middleware(['auth', 'verified'])
    ...
    ->group(function () {
        ...
        |--------------------------------------------------------------------------
        */
        Route::get('/create/government/{application_id?}', function (
            $application_id = null
        ) {
            return Inertia::render('applications/forms/government_application_form', [
                'application_id' => $application_id,
                'type' => 'Government',
                'step' => 1,
                'mode' => 'create',
            ]);
        })->name('applications.create.government');
        ...
        */
        Route::get('/edit/{application_id}/{type}', function (
            ...
            $view = match ($type) {
                'Company'   => 'applications/forms/company_application_form',
                'Government' => 'applications/forms/government_application_form',
                'Individual' => 'applications/forms/application_form_v2'
            };
