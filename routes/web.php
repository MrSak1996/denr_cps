...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    */
    Route::prefix('applications')->group(function () {
        ...
        Route::get('manual', fn() => Inertia::render('applications/manual'))
            ->name('applications.manual');
...
// CENRO
        Route::post('cenro/receive', [AssessmentController::class, 'receive'])->name('applications.cenro.receive');
        Route::post('cenro/return', [PENROController::class, 'returnApplication'])->name('applications.cenro.return');
        Route::post('cenro/endorse', [PENROController::class, 'endorseToFUS'])->name('applications.cenro.endorse');
        ...
        Route::post('fus/return', [AssessmentController::class, 'return'])->name('applications.fus.return');
